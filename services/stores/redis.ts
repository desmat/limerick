...
export function create(): Store {
  return {
    ...
    userHaikudles: new RedisStore<UserHaikudle>("userlimerickle2"),
    userHaikus: new RedisStore<UserHaiku>("userlimerick2"),
    userUsage: new RedisStore<UserUsage>("limerickuserusage2"),
